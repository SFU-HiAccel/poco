...
#define SB_CMSG_PAGE_MSB    (15)  // `page` is 8 bits wide  
#define SB_CMSG_PAGE_LSB    (8)
#define SB_CMSG_XCXR_MSB    (7)  // `xcxr` is 8 bits wide  
#define SB_CMSG_XCXR_LSB    (0)
