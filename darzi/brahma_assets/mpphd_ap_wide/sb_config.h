...
#define SB_RARBQS_DEPTH     (SB_BURST_SIZE)
#define SB_WARBQS_DEPTH     (SB_BURST_SIZE)
#define SB_NUNUSED          (4)

#define SB_NUM_PAGES        (512)
#define SB_PAGES_PER_XCSR   (SB_NUM_PAGES/SB_NXCSRS)
#define SB_MSG_SIZE         (8)       // bytes (64 bits)
#define SB_WORD_SIZE        (4)       // bytes (32 bits)
