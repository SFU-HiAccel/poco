...
sb_req_t sb_request_write(sb_dmsg_t dmsg, sb_pageid_t page_id, sb_pageid_t start_index, uint8_t burst_length, bool keep_mutex)
{
  #pragma HLS inline
  sb_req_t request = {0};
  ...
  cmsg.range(SB_CMSG_ADDR_MSB, SB_CMSG_ADDR_LSB) = start_index;      // start from a specific index
